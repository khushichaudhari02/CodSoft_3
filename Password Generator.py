...
# Heading
heading_label = tk.Label(root, text="Password Generator", font=("bold", 25))
...
length_label.pack()
length_scale = tk.Scale(root, from_=1, to=20, orient=tk.HORIZONTAL, length=200)
length_scale.set(6)
length_scale.pack(pady=2)
...
# Password Display
password_label = tk.Label(root, text="Password:",font=("bold", 15))
password_label.pack()
